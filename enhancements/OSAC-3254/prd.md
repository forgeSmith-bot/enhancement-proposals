...
- [ ] **API Payload Integrity:** The API Get and List endpoints for BareMetalInstances return the boot MAC address and primary IP address in the status section of the response payload.
